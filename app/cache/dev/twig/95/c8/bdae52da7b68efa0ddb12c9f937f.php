...
/* EspritMangerBundle:Manger:voir.html.twig */
class __TwigTemplate_95c8bdae52da7b68efa0ddb12c9f937f extends Twig_Template
{
...
<h2>
  ";
        ...
        if ((!(null === $this->getAttribute((isset($context["manager"]) ? $context["manager"] : $this->getContext($context, "manager")), "image")))) {
            // line 17
            echo "    <img src=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute($this->getAttribute((isset($context["manager"]) ? $context["manager"] : $this->getContext($context, "manager")), "image"), "webPath")), "html", null, true);
            echo "\" alt=\"";
 ...
 <div class=\"well\">
  ...
  <p>
    ...
    <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("espritmanager_modifier", array("id" => $this->getAttribute((isset($context["manager"]) ? $context["manager"] : $this->getContext($context, "manager")), "id"))), "html", null, true);
        echo "\" class=\"btn\">
      <i class=\"icon-edit\"></i>
      Modifier Manager
    </a>
...
";
    ...
    {
        return "EspritMangerBundle:Manger:voir.html.twig";
    }
